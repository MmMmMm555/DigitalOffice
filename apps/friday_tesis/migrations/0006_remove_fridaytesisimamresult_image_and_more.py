...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('friday_tesis', '0005_fridaytesisimamread_requirement_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('result', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='friday_tesis.fridaytesisimamresult', verbose_name='result_image')),
            ],
            options={
                'abstract': False,
            },
