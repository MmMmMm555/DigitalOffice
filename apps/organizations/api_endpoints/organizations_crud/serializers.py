...
class OrganizationSerializer(ModelSerializer):
    class Meta:
        model = Organization
        fields = ('id', 'imam', 'description', 'type', 'prisoner_type', 'institution_type', 'participant_type', 'date',)


class OrganizationDetailSerializer(ModelSerializer):
    class Meta:
        model = Organization
        fields = ('id', 'imam', 'description', 'type', 'prisoner_type', 'institution_type', 'participant_type', 'date', 'created_at', 'updated_at',)
...
class OrganizationListSerializer(ModelSerializer):
    class Meta:
        model = Organization
        fields = ('id', 'imam', 'type', 'prisoner_type', 'institution_type', 'participant_type', 'date',)
