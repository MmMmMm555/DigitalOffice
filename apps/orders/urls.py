...
from apps.orders.api_endpoints.order.views import DirectionsCreateView, DirectionsListView
from apps.orders.api_endpoints.seen_api.views import DirectionsEmployeeReadListView, DirectionsEmployeeReadView

urlpatterns = [
    # direction apis
    path('create/', DirectionsCreateView.as_view(), name='direction_create'),
