...
class IndividualConversationImages(models.Model):
    image = models.ImageField(upload_to='images/conversation_images/', validators=[FileExtensionValidator(
...
class IndividualConversation(BaseModel):
    imam = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='imam_individual_conversation')
    images = models.ManyToManyField(IndividualConversationImages, blank=False,)
    type = models.CharField(max_length=22, choices=Types.choices,
