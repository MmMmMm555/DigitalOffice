...
# class MosqueFloor(models.TextChoices):
...
class Mosque(BaseModel):
    ...
    location = PlainLocationField(verbose_name=_(
        "location"), based_fields=['city'], zoom=10)
    ...
    parking_capacity = models.IntegerField(
        verbose_name=_("parking_capacity"), default=0, blank=True)

    # floor = models.CharField(verbose_name=_(
    #     "floor"), max_length=15, choices=MosqueFloor.choices, blank=True, null=True)
    ...
    cultural_heritage = models.BooleanField(
        verbose_name=_("cultural_heritage"), default=False)

    fire_safety = models.BooleanField(
        verbose_name=_("fire_safety"), default=False)
    auto_fire_extinguisher = models.BooleanField(
        verbose_name=_("auto_fire_extinguisher"), default=False)
    fire_closet = models.BooleanField(
        verbose_name=_("fire_closet"), default=False)
    fire_signal = models.BooleanField(
        verbose_name=_("fire_signal"), default=False)
    evacuation_road = models.BooleanField(
        verbose_name=_("evacuation_road"), default=False)
    emergency_exit_door = models.BooleanField(
        verbose_name=_("emergency_exit_door"), default=False)

    service_rooms_bool = models.BooleanField(
        verbose_name=_("service_rooms_bool"), default=False)
    service_rooms = models.ManyToManyField(
        ServiceRoom, verbose_name=_("service_rooms"), blank=True)
    ...
    capacity = models.PositiveIntegerField(
        verbose_name=_("capacity"), default=0, blank=False)

    mosque_library = models.BooleanField(
        verbose_name=_("mosque_library"), default=False)
    ...
    fire_images = models.ManyToManyField(
        FireDefenseImages, verbose_name=_("fire_images"), blank=True)
