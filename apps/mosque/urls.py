...
urlpatterns = [
    ...
    path('choice-list/', MosqueChoiceListView.as_view(), name='mosque_choice_list'),
    ...
    path('fire_image/create', FireDefenseImagesCreateView.as_view(),
         name='fire_image_create'),
    path('fire_image/list', FireDefenseImagesListView.as_view(),
         name='fire_image_list'),
    path('fire_image/single/<int:pk>',
         FireDefenseImagesRetrieveView.as_view(), name='fire_image_single'),
]
